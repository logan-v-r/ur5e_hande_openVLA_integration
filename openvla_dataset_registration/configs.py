...
OXE_DATASET_CONFIGS = {
    "ur5e_openvla": {
        ...
        # The UR5e stores orientation as a UR rotation vector [rx, ry, rz],
        # not Euler roll-pitch-yaw. POS_EULER is used only to select the
        # six-value EEF layout expected by OpenVLA; state_encoding is removed
        # during dataset materialization and does not transform these values.
        "state_encoding": StateEncoding.POS_EULER,
        
        # Action remains:
        # [dx, dy, dz, drx, dry, drz, absolute_gripper_target].
        # The first six values are relative; the gripper target is absolute.
